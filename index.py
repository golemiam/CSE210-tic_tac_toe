...
class TicTacToe():
    ...
    def o_turn(self,_t):
        ...
        _x = int(column) * 50 - 57
        _y = (int(row) - 2) * 50 + 6
        self.draw_circle(_t, _x, _y, radius, fillcolor, pencolor)
    ...
    def x_turn(self,_t, tilt, length):
        """
        positions the x
        """
        column = input("Please select a column by typing the corresponding number: 1, 2, or 3: ")
    ...
    def draw_grid(self,_t):
        """
        Draws the playing area.
        """
        self.draw_vertical_line(_t, 50, -50, 90, 150)
        self.draw_vertical_line(_t, 0, -50, 90, 150)
        self.draw_horizontal_line(_t, -50, 50, 0, 150)
        self.draw_horizontal_line(_t, -50, 0, 0, 150)
        
    def draw_vertical_line(self,_t, _x, _y, tilt, length):
        """
    ...
    def draw_horizontal_line(self,_t, _x, _y, tilt, length):
        """
